...
export const ACCIONES = {
  ...
  // Fidelización: ABM de destinatarios desde la pantalla "Clientes de fidelización"
  FIDELIZACION_CLIENTE_CREADO: "FIDELIZACION_CLIENTE_CREADO",
  FIDELIZACION_CLIENTE_EDITADO: "FIDELIZACION_CLIENTE_EDITADO",
  ...
  // Encuestas de fábrica de Volkswagen: carga del Excel de pendientes, ABM de
  // vendedores y aviso por correo a cada uno con su lista.
  EXCEL_ENCUESTA_VW_IMPORTADO: "EXCEL_ENCUESTA_VW_IMPORTADO",
  VENDEDOR_VW_CREADO: "VENDEDOR_VW_CREADO",
  VENDEDOR_VW_EDITADO: "VENDEDOR_VW_EDITADO",
  VENDEDOR_VW_ELIMINADO: "VENDEDOR_VW_ELIMINADO",
  ...
  // Todos los casos en estado Interno eliminados de una vez (borrado lógico).
  CASOS_INTERNOS_ELIMINADOS: "CASOS_INTERNOS_ELIMINADOS",
